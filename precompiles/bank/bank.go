...
func NewPrecompile(
	...
	newABI, err := pcommon.LoadABI(f, "abi.json")
	if err != nil {
		return nil, err
	}
...
func (p Precompile) Run(evm *vm.EVM, contract *vm.Contract, readOnly bool) (bz []byte, err error) {
	...
	defer pcommon.HandleGasError(ctx, contract, initialGas, &err)()
	...
	default:
		return nil, fmt.Errorf(pcommon.ErrUnknownMethod, method.Name)
	}
...
func (Precompile) IsStateful() bool { return false }
