...
import (
	...
	evmosutils "github.com/evmos/ethermint/utils"
)
...
func (c Coin) ToSDKType() sdk.Coin {
	return sdk.NewCoin(c.Denom, sdk.NewInt(c.Amount.Int64()))
}
...
func SafeAdd(a, b sdk.Int) (res *big.Int, overflow bool) {
	res = a.BigInt().Add(a.BigInt(), b.BigInt())
	return res, res.BitLen() > DefaultMaxBitLen
}
