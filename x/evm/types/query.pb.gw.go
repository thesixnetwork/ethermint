...
var (
	...
	pattern_Query_EthCallWithOverride_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ethermint", "evm", "v1", "eth_call_overides"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_EstimateGasWithOverride_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ethermint", "evm", "v1", "estimate_gas_overides"}, "", runtime.AssumeColonVerbOpt(true)))
)
